...
function findWasmBinary() {
  return locateFile("droplet.wasm");
}
...
var ASM_CONSTS = {
  ...
  108486: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  108545: ($0, $1, $2, $3, $4) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  113027: () => Module["SDL3"].audioContext.sampleRate,
  113078: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  121650: () => Module["SDL3"]["mouse_x"],
  121688: () => Module["SDL3"]["mouse_y"],
  121726: $0 => Module["SDL3"]["mouse_buttons"][$0],
  121774: $0 => {
    var data = $0;
  ...
  124018: () => document.body.clientWidth,
  124056: () => document.body.clientHeight,
  124095: () => window.innerWidth,
  124125: () => window.innerHeight,
  124156: () => window.outerWidth,
  124186: () => window.outerHeight,
  124217: () => window.pageXOffset,
  124248: () => window.pageYOffset,
  124279: ($0, $1) => {
  ...
  130060: () => window.innerWidth,
  130090: () => window.innerHeight,
  130121: $0 => {
  ...
  130797: () => window.innerWidth,
  130827: () => window.innerHeight,
  130858: $0 => {
...
var wasmImports = {
  /** @export */ SDL_GetEmscriptenJoystickProduct,
  /** @export */ SDL_GetEmscriptenJoystickVendor,
  /** @export */ SDL_IsEmscriptenJoystickXInput,
